...
export const postComment = (dishId, rating, author, comment) => (dispatch) => {
    ...
    export const postContact = (contacts) => (dispatch) => {
      const newContact = {
         ...
         telnum: contacts.telnum,
         email: contacts.email,
         agree: contacts.agree,
         conType: contacts.conType,
      ...
      .then(response => response.json())
      .then(response => { alert("Thank you for your feedback!<br/>" + JSON.stringify(response)); })
      .catch(error => { alert("Feedback hasn't been posted. \nError: " + error.message); })
   }
